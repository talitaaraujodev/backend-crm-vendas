...
export class CustomerUpdateYupValidator {
    ...
    try {
      yup
        ...
        .shape({
          ...
          saleValue: yup.string().required('Valor é um campo obrigatório.'),
          agentId: yup.string().required('AgentId é um campo obrigatório.'),
        })
        .validateSync(
          {
            name: customer.name,
